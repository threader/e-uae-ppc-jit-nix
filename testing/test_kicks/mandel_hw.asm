; Mandelbrot calculator test for E-UAE
; Direct hardware banging version
; When the machine starts it calculates a certain Mandelbrot set and displays
; it on the screen. The code is not optimized for let us test the emulation
; speed while doing integer math operations.

; Please note that this test requires AGA chipset emulation (256 color screen).
