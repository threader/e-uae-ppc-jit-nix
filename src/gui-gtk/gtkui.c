...
static void make_cpu_widgets (GtkWidget *vbox)
{
    ...
    gtk_signal_connect (GTK_OBJECT (cspanel), "cpuidle-changed",
                        ...
                        NULL);
    gtk_signal_connect (GTK_OBJECT (cspanel), "dontbusywait-changed",
                        GTK_SIGNAL_FUNC (on_dontbusywait_changed),
                        NULL);
}
