...
static struct uae_hotkeyseq sdl_hotkeys[] =
{
    ...
    { MAKE_HOTKEYSEQ (SDLK_F12, SDLK_r, -1, -1,           INPUTEVENT_SPC_WARM_RESET) },
    { MAKE_HOTKEYSEQ (SDLK_F12, SDLK_LSHIFT, SDLK_r, -1,  INPUTEVENT_SPC_COLD_RESET)}, \
    ...
    { MAKE_HOTKEYSEQ (SDLK_F12, SDLK_m, -1, -1,           INPUTEVENT_SPC_TOGGLEMOUSEMODE) },
...
static struct uae_hotkeyseq sdl_quartz_hotkeys[] =
{
    ...
    { MAKE_HOTKEYSEQ (SDLK_F11, SDLK_r, -1, -1,           INPUTEVENT_SPC_WARM_RESET) },
    { MAKE_HOTKEYSEQ (SDLK_F11, SDLK_LSHIFT, SDLK_r, -1,  INPUTEVENT_SPC_COLD_RESET) },
    ...
    { MAKE_HOTKEYSEQ (SDLK_F11, SDLK_m, -1, -1,           INPUTEVENT_SPC_TOGGLEMOUSEMODE) },
