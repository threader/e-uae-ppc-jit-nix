...
\
    ...
    {DEFAULT_HOTKEYSEQ2 (RAWKEY_R,            INPUTEVENT_SPC_WARM_RESET)}, \
    {DEFAULT_HOTKEYSEQ3 (RAWKEY_LEFT_SHIFT, RAWKEY_R, INPUTEVENT_SPC_COLD_RESET)}, \
    {DEFAULT_HOTKEYSEQ2 (RAWKEY_D,            INPUTEVENT_SPC_ENTERDEBUGGER)}, \
    {DEFAULT_HOTKEYSEQ2 (RAWKEY_S,            INPUTEVENT_SPC_TOGGLEFULLSCREEN)}, \
    {DEFAULT_HOTKEYSEQ2 (RAWKEY_M,            INPUTEVENT_SPC_TOGGLEMOUSEMODE)}, \
